...
<section class="page-section cta">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                <h3><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
                ...
                <table class="table">
                    ...
                    @endforeach  
                        <tr>
                            ...
                            <td>
                                <a href="{{url('konfirmasi-check-out')}}" class="btn btn-success" onclick="return confirm('Anda Yakin akan melakukan Check Out?')">
